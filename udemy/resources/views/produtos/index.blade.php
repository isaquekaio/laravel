...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <form method="POST" action="{{url('produtos/busca')}}">
                ...
                <input class="form-control" type="text" id="busca" name="busca" placeholder="Procurar produto no site..." value="{{$buscar}}">
    ...
    <div>
        ...
        <p><strong>A quantidade de produtos com o valor maior que R $10,00 é: </strong>{{$maiorDezP}}</p>
    </div>
    {{$produtos->links()}}
@endsection
